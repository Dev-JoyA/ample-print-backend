...
export const filterDesignController = async (req: Request, res: Response) => {
  try {
    ...
    const filters: designService.IDesignFilter = {
      ...
      minVersion: req.query.minVersion ? parseInt(req.query.minVersion as string) : undefined,
      maxVersion: req.query.maxVersion ? parseInt(req.query.maxVersion as string) : undefined,
