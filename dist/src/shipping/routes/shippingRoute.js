 ...
 * @access Admin, SuperAdmin
 */
router.put("/:shippingId/tracking", checkAdmin, shippingController.updateShippingTracking);
/**
 * @route PATCH /api/v1/shipping/:shippingId/status
 * @desc Update shipping status
 * @access Admin, SuperAdmin
 */
router.patch("/:shippingId/status", checkAdmin, shippingController.updateShippingStatus);
/**
 ...
 * @access Admin, SuperAdmin
 */
router.get("/needing-invoice", checkAdmin, shippingController.getShippingNeedingInvoice);
/**
 ...
 */
router.get("/:shippingId", checkRole([UserRole.Customer, UserRole.Admin, UserRole.SuperAdmin]), shippingController.getShippingById);
/**
 * @route GET /api/v1/shipping/order/:orderId
 * @desc Get shipping by order ID
 * @access Owner, Admin, SuperAdmin
 */
router.get("/order/:orderId", checkRole([UserRole.Customer, UserRole.Admin, UserRole.SuperAdmin]), shippingController.getShippingByOrderId);
export default router;
//# sourceMappingURL=shippingRoute.js.map