...
export declare const updateCollection: (req: Request<{
    id: string;
}>, res: Response) => Promise<void>;
export declare const deleteCollection: (req: Request<{
    id: string;
}>, res: Response) => Promise<void>;
export declare const getCollectionsPaginated: (req: Request, res: Response) => Promise<void>;
export declare const getCollectionById: (req: Request<{
    id: string;
}>, res: Response) => Promise<void>;
...
export declare const getProductsByCollectionId: (req: Request<{
    collectionId: string;
}>, res: Response) => Promise<void>;
