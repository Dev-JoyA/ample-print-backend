...
/* ===================== COLLECTION ROUTES ===================== */
// Create collection
router.post("/collections", authMiddleware, checkAdmin, productController.createCollection);
// Update collection
router.put("/collections/:id", authMiddleware, checkAdmin, productController.updateCollection);
// Delete collection
router.delete("/collections/:id", authMiddleware, checkAdmin, productController.deleteCollection);
...
router.post("/collections/:collectionId/products", authMiddleware, checkAdmin, upload.array("images", 3), productController.createProduct);
/* ===================== PRODUCT UPDATE / DELETE ===================== */
// Update product
router.put("/products/:id", authMiddleware, checkAdmin, upload.array("images", 10), productController.updateProduct);
// Delete product
router.delete("/products/:id", authMiddleware, checkAdmin, productController.deleteProduct);
/* ===================== PRODUCT LISTING ===================== */
