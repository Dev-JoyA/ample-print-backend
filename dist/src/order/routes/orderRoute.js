...
import { createOrder, searchByOrderNumber, updateOrder, deleteOrder, getOrderById, getUserOrders, getAllOrders, updateOrderStatus, filterOrders, getOrdersReadyForInvoice, getPaidOrders, getPartiallyPaidOrders, getPendingPaymentOrders, getOrdersReadyForShipping, superAdminCreateOrder, addItemToOrder, getUserActiveOrders, markOrderAsAwaitingInvoice, // NEW IMPORT
...
router.patch("/:orderId/mark-awaiting-invoice", checkAdmin, // Admin or Super Admin can mark as awaiting invoice
markOrderAsAwaitingInvoice);
// ==================== SUPER ADMIN ONLY ROUTES ====================
// Super admin creates order for a customer
router.post("/super-admin/create/:customerId", checkSuperAdmin, superAdminCreateOrder);
