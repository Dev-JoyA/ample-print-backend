...
export declare const sendOrderConfirmation: (to: string, name: string, orderNumber: string, items: Array<{
    productName: string;
    quantity: number;
    price: number;
    total: number;
}>, total: number, deposit?: boolean) => Promise<void>;
...
export declare const sendReceiptUploaded: (to: string, name: string, orderNumber: string, amount: number, transactionId: string, receiptUrl: string) => Promise<void>;
...
export declare const sendOrderShipped: (to: string, name: string, orderNumber: string, carrier?: string, trackingNumber?: string, estimatedDelivery?: string, shippingAddress?: string, trackingUrl?: string, driverName?: string, driverPhone?: string) => Promise<void>;
...
export declare const sendAdminNewOrder: (to: string, orderNumber: string, customerName: string, customerEmail: string, total: number, items: Array<{
    productName: string;
    quantity: number;
    price: number;
    total: number;
...
declare const emailService: {
    ...
    sendOrderConfirmation: (to: string, name: string, orderNumber: string, items: Array<{
        productName: string;
        quantity: number;
        price: number;
        total: number;
    ...
    sendReceiptUploaded: (to: string, name: string, orderNumber: string, amount: number, transactionId: string, receiptUrl: string) => Promise<void>;
    ...
    sendOrderShipped: (to: string, name: string, orderNumber: string, carrier?: string, trackingNumber?: string, estimatedDelivery?: string, shippingAddress?: string, trackingUrl?: string, driverName?: string, driverPhone?: string) => Promise<void>;
    ...
    sendAdminNewOrder: (to: string, orderNumber: string, customerName: string, customerEmail: string, total: number, items: Array<{
        productName: string;
        quantity: number;
        price: number;
        total: number;
